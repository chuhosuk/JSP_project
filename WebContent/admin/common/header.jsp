...
<!----------- header 시작 ---------->
	<nav class="navbar">
		...
		<c:if test="${sessionScope.sessionID == null}">
			...
			<li><a href="${path}/login.do"><i class="fa-solid fa-user"></i></a></li>
		</c:if>
		...
		<c:if test="${sessionScope.sessionID != null}">
			...
			<li><a href="${path}/ad_product_list.pd">상품목록</a></li><!-- 마이페이지 : 회원수정 -->
			<li><a href="${path}/login.do"><i class="fa-solid fa-user"></i></a></li> <!-- 회원수정 : 회원탈퇴 -->
		</c:if>
