						...
						<c:if test="${sessionScope.sessionID!=null}">
							<table>
								<tr>
									<td colspan="2" align="center">
										<h3>
											<span style="color: #FF82AA;"><b>${sessionScope.sessionID}</b></span>관리자님 반갑습니다.
										</h3>
									</td>
								</tr>
								...
								<tr>
									<td colspan="3" style="border-bottom: none;">
										<br>
										<div align="right">
											<input class="inputButton" type="button" value="상품관리" onclick="window.location='${path}/ad_product_list.pd'">
											<input class="inputButton" type="button" value="주문관리" onclick="window.location='${path}/orderList.do'">
											<input class="inputButton" type="button" value="결산" onclick="window.location='${path}/deleteCustomer.do'">
